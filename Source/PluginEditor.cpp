...
void BasicDelayAudioProcessorEditor::resized()
{
    ...
    sliderDelayTime->setBounds (96, 112, 224, 24);
    sliderFeedback->setBounds (96, 232, 224, 24);
    labelDelayTime->setBounds (96, 80, 150, 24);
    labelFeedback->setBounds (96, 200, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="BasicDelayAudioProcessorEditor"
  ...
  <SLIDER name="delay time " id="b009bccbe3bbabb3" memberName="sliderDelayTime"
          virtualName="" explicitFocusOrder="0" pos="96 112 224 24" min="0.010000000000000000208"
          max="1" int="0" style="LinearHorizontal" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
  <SLIDER name="feedback" id="894e6a5fe7947683" memberName="sliderFeedback"
          virtualName="" explicitFocusOrder="0" pos="96 232 224 24" min="0"
          max="0.94999999999999995559" int="0" style="LinearHorizontal"
          textBoxPos="TextBoxLeft" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1" needsCallback="1"/>
  <LABEL name="" id="754abfbeea3a9dc5" memberName="labelDelayTime" virtualName=""
         explicitFocusOrder="0" pos="96 80 150 24" edTextCol="ff000000"
         edBkgCol="0" labelText="Delay time (seconds)" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" bold="0" italic="0" justification="33"/>
  <LABEL name="new label" id="2c90e5de34932039" memberName="labelFeedback"
         virtualName="" explicitFocusOrder="0" pos="96 200 150 24" edTextCol="ff000000"
